...
import MySQLdb
from setting import MYSQL_DB_HOST, MYSQL_DB_PROT, MYSQL_DB_NAME, MYSQL_DB_USER, MYSQL_DB_PASSWD
...
class mysql(object):
    ...
    def __init__(self):
        self.host = MYSQL_DB_HOST
        self.port = MYSQL_DB_PROT
        self.user = MYSQL_DB_USER
        self.passwd = MYSQL_DB_PASSWD
